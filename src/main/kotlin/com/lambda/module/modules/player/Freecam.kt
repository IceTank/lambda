...
object Freecam : Module(
    ...
    private val rotateMode by setting("Rotate Mode", FreecamRotationMode.None, "Rotation mode")
        .onValueChange { _, it ->
            if (it == FreecamRotationMode.LookAtTarget) {
    ...
    init {
        ...
        // Higher priority than RotationManager so it can use this target before RotationManager mutates mc.crosshairTarget.
        listen<RenderEvent.UpdateTarget>({ 1 }) { event ->
